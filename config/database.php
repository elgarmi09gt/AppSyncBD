...
return [
    ...
    */
    ...
    'default' => env('DB_CONNECTION_LOC', 'automatisationDB'),
    ...
    */
    ...
    'connections' => [
        ...
        'automatisationDB' => [
            'driver' => 'mysql',
            'host' => env('DB_HOST_LOC', '127.0.0.1'),
            'port' => env('DB_PORT_LOC', '3306'),
            'database' => env('DB_DATABASE_LOC', 'forge'),
            'username' => env('DB_USERNAME_LOC', 'forge'),
            'password' => env('DB_PASSWORD_LOC', ''),
            'unix_socket' => env('DB_SOCKET_LOC', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'prefix_indexes' => true,
